...
<form class="form-horizontal" action="alteracliente3.php" method="post" enctype="multipart/form-data" name="alterar" >
...
<input type="identidade" class="form-control" value="<?php echo $identidade; ?>"id="dtnasc" placeholder="Data de Nascimento" name="dtnasc">
    </div> 	
<div class="form-group">
...
<input type="text" class="form-control" id="endereco" value="<?php echo $endereco;?>"  placeholder="Endereço" name="endereco" readonly/>
</div> 		
<div class="form-group">
...
<input type="text" value="<?php echo $bairro;?>" class="form-control" id="bairro" placeholder="Bairro" name="bairro" readonly/>
</div>

<div class="form-group">
      <label for="cidade">Cidade:</label>
<input type="text" class="form-control" value="<?php echo $cidade;?>"  id="cidade" placeholder="Cidade" name="cidade" readonly/>
</div>
<div class="form-group">
<label for="estado">Estado:</label>
<input type="text" class="form-control" value="<?php echo $estado;?>" id="uf" placeholder="Estado" name="estado" readonly/></div>
...
<img src="fotoscliente/<?=$imagem?>" height="190" width="150">
</div>
